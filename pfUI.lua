...
function pfUI:UpdateColors()
  if pfUI.expansion == "vanilla" then
    ...
    RAID_CLASS_COLORS = {
      ["WARRIOR"] = { r = 0.87, g = 0.67, b = 0.45, colorStr = "ffdfaa73" },
      ["MAGE"]    = { r = 0,    g = 0.85, b = 1,    colorStr = "ff00d8ff" },
      ["ROGUE"]   = { r = 1,    g = 0.95, b = 0.41, colorStr = "fffff368" },
      ["DRUID"]   = { r = 1,    g = 0.66, b = 0,    colorStr = "ffffa900" },
      ["HUNTER"]  = { r = 0.67, g = 0.93, b = 0.31, colorStr = "ffabed4f" },
      ["SHAMAN"]  = { r = 0.04, g = 0.49, b = 0.93, colorStr = "ff0a7ded" },
      ["PRIEST"]  = { r = 0.99, g = 0.99, b = 0.99, colorStr = "fffcfcfc" },
      ["WARLOCK"] = { r = 0.6,  g = 0.27, b = 1,    colorStr = "ff9946ff" },
      ["PALADIN"] = { r = 1,    g = 0.58, b = 0.85, colorStr = "ffff95d8" },
    }
