...
function pfUI.uf:UpdateConfig()
  ...
  f.power:SetFrameLevel(f.hp:GetFrameLevel() + 4)
  ...
  f.leaderIcon.texture:SetTexture(pfUI.media["img:leader"])
  ...
  f.lootIcon.texture:SetTexture(pfUI.media["img:loot"])
  ...
  f.restIcon.texture:SetTexture(pfUI.media["img:rest"], true)
