...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("buffs",      nil,           "aspect_ratio",     "1")
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "classiconsize",    "32")
    pfUI:UpdateConfig("unitframes", unit,      "classiconoffx",    "0")
    pfUI:UpdateConfig("unitframes", unit,      "classiconoffy",    "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthpleftsize",    "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthpcentersize",  "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txthprightsize",   "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txtpowerleftsize",   "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txtpowercentersize", "0")
    ...
    pfUI:UpdateConfig("unitframes", unit,      "txtpowerrightsize",  "0")
  ...
  for i=1,12 do
    ...
    pfUI:UpdateConfig("bars",     "bar"..i,      "aspect_ratio",     "1")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "targetarrow",      "1")
  ...
  pfUI:UpdateConfig("nameplates", "name",        "offsetx",          "0")
  pfUI:UpdateConfig("nameplates", "name",        "offsety",          "5")
  pfUI:UpdateConfig("nameplates", "level",       "fontsize",         "12")
  pfUI:UpdateConfig("nameplates", "level",       "offsetx",          "0")
  pfUI:UpdateConfig("nameplates", "level",       "offsety",          "0")
  pfUI:UpdateConfig("nameplates", "healthtext",  "fontsize",         "10")
  pfUI:UpdateConfig("nameplates", "healthtext",  "offsetx",          "0")
  pfUI:UpdateConfig("nameplates", "healthtext",  "offsety",          "0")
