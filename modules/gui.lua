pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Unit Frames"], T["General"], function()
      ...
      CreateConfig(nil, T["Hook Behind Indicator to Portrait Frame"], C.unitframes, "behind_hook_portrait", "checkbox", nil, nil, nil, nil, "vanilla" )
    ...
    for id, data in ipairs(unitframeSettings) do
      ...
      CreateGUIEntry(T["Unit Frames"], t, function()
        ...
        CreateConfig(U[c], T["Left Text Size"], C.unitframes[c], "txthpleftsize")
        ...
        CreateConfig(U[c], T["Center Text Size"], C.unitframes[c], "txthpcentersize")
        ...
        CreateConfig(U[c], T["Right Text Size"], C.unitframes[c], "txthprightsize")
        ...
        CreateConfig(U[c], T["Left Text Size"], C.unitframes[c], "txtpowerleftsize")
        ...
        CreateConfig(U[c], T["Center Text Size"], C.unitframes[c], "txtpowercentersize")
        ...
        CreateConfig(U[c], T["Right Text Size"], C.unitframes[c], "txtpowerrightsize")
    ...
    CreateGUIEntry(T["Buffs"], T["Buff/Debuff Icons"], function()
      ...
      CreateConfig(U["buff"], T["Aspect Ratio"], C.buffs, "aspect_ratio")
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Show Arrows Beside Target Nameplate"], C.nameplates, "targetarrow", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Level Text Font Size"], C.nameplates.level, "fontsize")
      CreateConfig(U["nameplates"], T["Level Text X-Offset"], C.nameplates.level, "offsetx")
      CreateConfig(U["nameplates"], T["Level Text Y-Offset"], C.nameplates.level, "offsety")
      ...
      CreateConfig(U["nameplates"], T["Name X Offset"], C.nameplates.name, "offsetx")
      CreateConfig(U["nameplates"], T["Name Y Offset"], C.nameplates.name, "offsety")
      ...
      CreateConfig(U["nameplates"], T["Health Text Font Size"], C.nameplates.healthtext, "fontsize")
      CreateConfig(U["nameplates"], T["Health Text X-Offset"], C.nameplates.healthtext, "offsetx")
      CreateConfig(U["nameplates"], T["Health Text Y-Offset"], C.nameplates.healthtext, "offsety")
